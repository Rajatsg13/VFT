...
<head>
  ...
  <![endif]-->
	...
	<script
		type="application/ld+json">{"@context":"http:\/\/schema.org","@type":"Organization","url":"https://vfinetune.com/","sameAs":[],"name":"Asset Online Pvt Limited","logo":""}</script>
	<!-- / Yoast SEO plugin. -->
...
<body>
	...
	<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light sc_nav_bg">
		<a class="navbar-brand" href="https://vfinetune.com"><img src="../images/info_logo.jpg" style="height:57px;"
	...
	<div class="container-fluid sc_no_padding industry_header_bg" style="background:url(../images/rfid/rfid.jpg);	background-size:cover;
	background-position:center center;">
		<div class="container">
			<div class="row  text-left">
				<div class="col-md-8 col-xs-12">
					<h1 class="cm_title"><span>RFID - VaaS enabling</span></h1>
					<h1 class="sc_title"> Business Process Automation </h1>

				</div>
				<div class="col-md-6 ">
					<p class="sc_title_tagline mobile_view_none" style="font-size:20px">We assist companies to Maximize
						productivity and Minimize Operational Cost<br> on all Business Processes, increases day-to-day
	...
	<div class="container">
		<h1 class="pink_title">Business application </h1>

		<div class="mobile_common_content">
			<p class="hc_content" style="text-align:justify;">Using RFID Technology to improve your business, can
				potentially
				improve the efficiency of work, frequency of business, push promotion activities
				and smart tracking. Manual and physical effort will be reduced and thus automatically saves the
				time. Our Application will accelerate the revenue of the company
				by giving a speedy response to customers.
				The implementing analytical approach in all our App developments will reflect in your dashboard.
				Smart Dashboard represents the Consolidated Data. It's accessible to anywhere at anytime. If any
				malpractice happens, management will know within a second
				by means of RFID Technology.</p>
		</div>
	</div>


	<div class="container mob_padding">
		<h1 class="pink_title">Our VaaS Approaches</h1>

		<div class="row">
			<div class="col-sm-6 col-md-3 col-xs-12 mt-3">
				<div class="text-center">
					<img src="../images/rfid/pharmacy.jpg" style="height:192px" class="img-fluid rounded-circle"
						alt="vfinetune">
				</div>
				<div class="type_title_align">
					<h3 class="type_title" style="font-size:20px">Pharmacy</h3>
				</div>

			</div>
			<div class="col-sm-6 col-md-3 col-xs-12 mt-3">
				<div class="text-center">
					<img src="../images/rfid/textile.jpg" style="height:192px" class="img-fluid rounded-circle"
						alt="vfinetune">
				</div>
				<div class="type_title_align">
					<h3 class="type_title" style="font-size:20px">Textile</h3>
				</div>

			</div>
			<div class="col-sm-6 col-md-3 col-xs-12 mt-3">
				<div class="text-center">
					<img src="../images/rfid/college.jpg    " class="img-fluid rounded-circle" alt="vfinetune">
				</div>
				<div class="type_title_align">
					<h3 class="type_title" style="font-size:20px">Institution/Company</h3>
				</div>
			...
			<div class="col-sm-6 col-md-3 col-xs-12 mt-3">
				<div class="text-center">
					<img src="../images/rfid/rfids.jpg" style="height:195px" class="img-fluid rounded-circle"
						alt="vfinetune">
				</div>
				<div class="type_title_align">
					<h3 class="type_title" style="font-size:20px">Appartment/Villa</h3>
					</h3>
				</div>
	...
	<div class="container mob_padding">
		<h1 class="pink_title">Improve your business</h1>

		<div class="row">
			<div class="col-sm-12">
				<ul class="mob_imp_bus">
					<li>Achieve efficiency & Productivity in operations</li>
					<li>Integrate entire business</li>
					<li>Reduce physical effort & increase operational effectiveness</li>
					<li>Enables the direct control of your Assets/Premises</li>
					<li>Provides better backup & disaster recovery</li>
					<li>Consolidate data on a daily basis</li>
					<li>Enhanced security for your Goods</li>
				</ul>
			</div>
				...
				<div class="col-sm-3 text-center">
					...
					<div class="col-sm-6 text-center">
						<div class="copy_links">
							<p class="copyright_content">&copy; Copyrights 2024 by <a href="#">vfinetune Limited </a>
							</p>
					...
					<div class="col-sm-3 text-right">
						<a href="https://vfinetune.com"><img src="../images/info_logo.jpg" class="img-fluid"
								style="width:140px;height:40px;margin-top:10px" alt="vfinetune"></a>
					</div>
				</div>
			</div>
		</div>
